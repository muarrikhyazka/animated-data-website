...
lib.ssMetadata = [
		{name:"BPS Datastory _ Monas_atlas_1", frames: [[500,116,206,99],[500,0,238,114],[0,1450,1372,221],[0,0,498,1448]]}
];
...
(lib.CachedBmp_6 = function() {
	this.initialize(ss["BPS Datastory _ Monas_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(961.95,244.3,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_1();
	this.instance_1.setTransform(236,49.25,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Shark_left
	this.instance_2 = new lib.Sharkleft();
	this.instance_2.setTransform(186.5,579.45,1,1,0,0,0,51.5,24.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// Shark_right
	this.instance_3 = new lib.Sharkright();
	this.instance_3.setTransform(503.5,620.25,1,1,0,0,0,59.5,28.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

	// Bg_2
	this.instance_4 = new lib.Bg2();
	this.instance_4.setTransform(2108.65,586.55,1,1,0,0,0,2109.9,670.5);
...
p.nominalBounds = new cjs.Rectangle(1775,456.1,2443.8,800.9999999999999);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/BPS Datastory _ Monas_atlas_1.png", id:"BPS Datastory _ Monas_atlas_1"}
	],
	preloads: []
};
